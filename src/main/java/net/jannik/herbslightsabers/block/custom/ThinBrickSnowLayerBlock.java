...
public class ThinBrickSnowLayerBlock extends Block {
    ...
    public ThinBrickSnowLayerBlock(Settings settings) {
        super(settings);
        ...
        this.shapesByState = ImmutableMap.copyOf(
                (Map<? extends BlockState, ? extends VoxelShape>)this.stateManager
                        .getStates()
                        .stream()
                        .collect(Collectors.toMap(Function.identity(), ThinBrickSnowLayerBlock::getShapeForState))
        );
    }
